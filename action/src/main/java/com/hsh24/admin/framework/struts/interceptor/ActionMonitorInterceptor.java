...
import com.hsh24.admin.framework.util.ClientUtil;
...
public class ActionMonitorInterceptor implements Interceptor {
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		com.hsh24.admin.framework.annotation.ActionMonitor actionLog =
			method.getAnnotation(com.hsh24.admin.framework.annotation.ActionMonitor.class);
		if (actionLog != null) {
